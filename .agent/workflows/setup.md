...
- `CLAUDE.md` dosyasındaki `Öğrenci Gelişim Takip Sistemi (İlkokul) - Premium Educators' Hub`, `Öğrenci Gelişim Takip Sistemi (İlkokul) - Premium Educators' Hub — Premium SaaS Uygulaması`, `[TECH_STACK]` gibi alanları gerçek değerlerle değiştir
